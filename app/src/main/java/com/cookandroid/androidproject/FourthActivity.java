            ...
            public void onClick(View v) {
                if (textView.getText().toString().isEmpty()) {
                    ...
                    if (backPressCount == 3) {
                        ...
                        Toast.makeText(FourthActivity.this, "뒤로 버튼을 " + (3 - backPressCount) + "번 더 누르면 첫 번째 화면으로 돌아갑니다.", Toast.LENGTH_SHORT).show();
                        handler.removeCallbacks(resetBackPressCount);
                        handler.postDelayed(resetBackPressCount, 2000); // 2초 후에 backPressCount 초기화
                    }
                } else {
